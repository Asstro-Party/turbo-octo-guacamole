...
function initializeGameState(lobbyId) {
  ...
  const state = {
    ...
    walls: [
      ...
      { id: 0, position: { x: 40, y: 40 }, health: 100, isHorizontal: true },
      { id: 1, position: { x: 40, y: 140 }, health: 100, isHorizontal: false },
      { id: 2, position: { x: 40, y: 40 }, health: 100, isHorizontal: false },
