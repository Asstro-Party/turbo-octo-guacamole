...
function initializeGameState(lobbyId) {
  ...
  const state = {
    ...
    walls: [
      ...
      { id: 0, position: { x: 180, y: 200 }, health: 100, isHorizontal: true },
      { id: 1, position: { x: 140, y: 125 }, health: 100, isHorizontal: false },
      { id: 2, position: { x: 180, y: 40 }, health: 100, isHorizontal: false },
